...
public class GoogleStepDef {
	...
	public void setUp() throws IOException {
		fileLoc = new FileInputStream("C:\\Users\\P102GJPH1\\eclipse-workspace\\IBM_Batch2.BDD.TestAutomation\\src\\test\\java\\com\\qa\\testdata\\config.properties");
		prop = new Properties();
		prop.load(fileLoc);
...
public void the_title_of_page_should_be_same_as(String SearchTxtField) {
	...
	//@When("The user types automation testing search item")
	//public void the_user_types_automation_testing_search_item() throws InterruptedException {
	//	
